  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-3xl mx-auto">
        <FadeIn>
          <div
            className={`relative rounded-3xl border ${s.border} bg-gradient-to-br ${s.bg} to-slate-950/40 p-10 md:p-14 text-center overflow-hidden transition-colors duration-500`}
          >
            ...
            <div className="relative z-10">
              ...
              {/* Title */}
              <h2 className="text-2xl md:text-4xl font-bold leading-tight mb-8 text-white transition-all duration-300">
                {s.titleStart}
                <br />
              ...
              {/* Insight */}
              <p className="text-slate-400 text-base leading-relaxed max-w-xl mx-auto mb-6 italic transition-all duration-300">
                {s.insight}
              </p>

              {/* Close line */}
              <p className={`${s.titleSpan} font-semibold text-lg mb-10 transition-colors duration-300 whitespace-pre-line`}>
                {s.close}
              </p>
              ...
              {/* Final question */}
              <p className="text-white text-2xl md:text-3xl font-bold leading-tight mb-8">
              ...
              <a
                href="#contacto"
                className="inline-block bg-white hover:bg-white/90 text-slate-950 font-bold px-8 py-4 rounded-xl transition-colors duration-200 cursor-pointer tracking-wide text-sm uppercase"
              >
